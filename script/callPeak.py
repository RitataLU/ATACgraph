...
def main():
	...
	parser.add_argument("-shift",help="shift from integration site",dest='shift',default=10,type=int)
	parser.add_argument("-ES",help="extend size from integration site",dest='extend',default=20,type=int)
	parser.add_argument("-bs",help="binsize for bigwig",dest='binsize',default=10,type=int)
